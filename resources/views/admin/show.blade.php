...
<body class="bg-gray-100">
    <div class="container mx-auto mt-10">
        ...
        <div class="bg-white p-5 rounded shadow">
            ...
            <div class="mt-4">
                <a href="{{ route('admin.edit', $adidas->id) }}" class="bg-yellow-500 text-white px-4 py-2 rounded">Edit</a>
                <form action="{{ route('admin.destroy', $adidas->id) }}" method="POST" class="inline">
                    @csrf
                    @method('DELETE')
